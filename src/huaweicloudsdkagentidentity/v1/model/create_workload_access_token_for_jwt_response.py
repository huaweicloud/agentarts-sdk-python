...
class CreateWorkloadAccessTokenForJwtResponse(SdkResponse):
    ...
    def workload_access_token(self):
        r"""Gets the workload_access_token of this CreateWorkloadAccessTokenForJwtResponse.
        ...
        :return: The workload_access_token of this CreateWorkloadAccessTokenForJwtResponse.
        :rtype: str
        """
    ...
    def workload_access_token(self, workload_access_token):
        r"""Sets the workload_access_token of this CreateWorkloadAccessTokenForJwtResponse.

        An opaque token representing the identity of both the workload and the user (or just the workload if not acting on behalf of a user)

        :param workload_access_token: The workload_access_token of this CreateWorkloadAccessTokenForJwtResponse.
        :type workload_access_token: str
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("CreateWorkloadAccessTokenForJwtResponse.to_dict() is deprecated and no longer maintained, "
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateWorkloadAccessTokenForJwtResponse):
            return False
