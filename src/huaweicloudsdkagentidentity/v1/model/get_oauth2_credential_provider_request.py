...
class GetOauth2CredentialProviderRequest:
    ...
    def __init__(self, credential_provider_name=None):
        r"""GetOauth2CredentialProviderRequest
    ...
    def credential_provider_name(self):
        r"""Gets the credential_provider_name of this GetOauth2CredentialProviderRequest.

        The name of the credential provider.

        :return: The credential_provider_name of this GetOauth2CredentialProviderRequest.
        :rtype: str
        """
    ...
    def credential_provider_name(self, credential_provider_name):
        r"""Sets the credential_provider_name of this GetOauth2CredentialProviderRequest.

        The name of the credential provider.

        :param credential_provider_name: The credential_provider_name of this GetOauth2CredentialProviderRequest.
        :type credential_provider_name: str
        """
