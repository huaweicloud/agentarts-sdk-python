...
class GetResourceOauth2TokenRequestBody:
    ...
    def authorization_details(self):
        r"""Gets the authorization_details of this GetResourceOauth2TokenRequestBody.

        RFC 9396 Rich Authorization Request (RAR) details: fine-grained authorization metadata to enforce precise access control, compatible with both USER_FEDERATION and M2M OAuth2 flows. This replaces the limitations of broad OAuth2 scopes with resource+action level granularity

        :return: The authorization_details of this GetResourceOauth2TokenRequestBody.
        :rtype: list[:class:`huaweicloudsdkagentidentity.v1.RichAuthorizationDetail`]
        """
        return self._authorization_details

    @authorization_details.setter
    def authorization_details(self, authorization_details):
        r"""Sets the authorization_details of this GetResourceOauth2TokenRequestBody.

        RFC 9396 Rich Authorization Request (RAR) details: fine-grained authorization metadata to enforce precise access control, compatible with both USER_FEDERATION and M2M OAuth2 flows. This replaces the limitations of broad OAuth2 scopes with resource+action level granularity

        :param authorization_details: The authorization_details of this GetResourceOauth2TokenRequestBody.
        :type authorization_details: list[:class:`huaweicloudsdkagentidentity.v1.RichAuthorizationDetail`]
        """
