...
"""
        ...
        with patch("agentarts.toolkit.operations.runtime.download_files._get_data_endpoint") as mock_endpoint:
            with patch("agentarts.toolkit.operations.runtime.download_files.RuntimeClient") as mock_client:
                ...
                result = download_runtime_files(path="test.txt", output=output_path)
...
"""
        ...
        with patch("agentarts.toolkit.operations.runtime.download_files._get_data_endpoint") as mock_endpoint:
            with patch("agentarts.toolkit.operations.runtime.download_files.RuntimeClient") as mock_client:
                ...
                output_path = str(tmp_path / "output.txt")
                download_runtime_files(path="/home/user/custom/file.txt", output=output_path)
...
"""
        ...
        with patch("agentarts.toolkit.operations.runtime.download_files._get_data_endpoint") as mock_endpoint:
            with patch("agentarts.toolkit.operations.runtime.download_files.RuntimeClient") as mock_client:
                ...
                result = download_runtime_files(path="/home/user/data", output=output_dir, recursive=True)
...
"""
        ...
        with patch("agentarts.toolkit.operations.runtime.download_files._get_data_endpoint") as mock_endpoint:
            with patch("agentarts.toolkit.operations.runtime.download_files.RuntimeClient") as mock_client:
                ...
                output_path = str(tmp_path / "output.txt")
                download_runtime_files(path="/home/user/test.txt", output=output_path, session_id="session-123")
