"""
Finance Agent Demo - Memory Space Setup (run once)
...
environment variables before running finance_agent.py.
...
def _check_and_clear_sessions_json():
    ...
    while True:
        ...
        if choice in ("y", "yes"):
            ...
            print("       sessions.json or create new sessions in finance_agent.py.")
            return
        else:
...
def main():
    ...
    print("=" * 60)
    print("Finance Agent - Memory Space Setup")
    print("=" * 60)
    ...
    print("  uv run python examples/finance_adk/finance_agent.py")
