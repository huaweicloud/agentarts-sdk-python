...
class GetWorkloadIdentityRequest:
    ...
    def workload_identity_name(self):
        r"""Gets the workload_identity_name of this GetWorkloadIdentityRequest.

        The name of the workload identity.

        :return: The workload_identity_name of this GetWorkloadIdentityRequest.
        :rtype: str
        """
    ...
    def workload_identity_name(self, workload_identity_name):
        r"""Sets the workload_identity_name of this GetWorkloadIdentityRequest.

        The name of the workload identity.

        :param workload_identity_name: The workload_identity_name of this GetWorkloadIdentityRequest.
        :type workload_identity_name: str
        """
