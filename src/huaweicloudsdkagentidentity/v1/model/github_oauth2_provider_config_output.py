...
class GithubOauth2ProviderConfigOutput:
    ...
    def __init__(self, oauth2_discovery=None, client_id=None):
        r"""GithubOauth2ProviderConfigOutput
    ...
    def oauth2_discovery(self):
        r"""Gets the oauth2_discovery of this GithubOauth2ProviderConfigOutput.

        :return: The oauth2_discovery of this GithubOauth2ProviderConfigOutput.
    ...
    def oauth2_discovery(self, oauth2_discovery):
        r"""Sets the oauth2_discovery of this GithubOauth2ProviderConfigOutput.

        :param oauth2_discovery: The oauth2_discovery of this GithubOauth2ProviderConfigOutput.
        :type oauth2_discovery: :class:`huaweicloudsdkagentidentity.v1.Oauth2Discovery`
        """
    ...
    @property
    def client_id(self):
        r"""Gets the client_id of this GithubOauth2ProviderConfigOutput.

        Client ID for OAuth2 application.

        :return: The client_id of this GithubOauth2ProviderConfigOutput.
        :rtype: str
        """
    ...
    def client_id(self, client_id):
        r"""Sets the client_id of this GithubOauth2ProviderConfigOutput.

        Client ID for OAuth2 application.

        :param client_id: The client_id of this GithubOauth2ProviderConfigOutput.
        :type client_id: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GithubOauth2ProviderConfigOutput):
            return False
