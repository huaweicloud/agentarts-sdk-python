...
class GetOauth2CredentialProviderResponse(SdkResponse):
    ...
    def __init__(self, credential_provider=None):
        r"""GetOauth2CredentialProviderResponse
    ...
    def credential_provider(self):
        r"""Gets the credential_provider of this GetOauth2CredentialProviderResponse.

        :return: The credential_provider of this GetOauth2CredentialProviderResponse.
    ...
    def credential_provider(self, credential_provider):
        r"""Sets the credential_provider of this GetOauth2CredentialProviderResponse.

        :param credential_provider: The credential_provider of this GetOauth2CredentialProviderResponse.
        :type credential_provider: :class:`huaweicloudsdkagentidentity.v1.Oauth2CredentialProvider`
        """
    ...
    def to_dict(self):
        import warnings
        warnings.warn("GetOauth2CredentialProviderResponse.to_dict() is deprecated and no longer maintained, "
